...
import com.itc.livebroadcast.core.RESSoftAudioCore;
...
public class RESAudioClient {
    ...
    public boolean start(RESFlvDataCollecter flvDataCollecter, IMediaMuxerListener mediaMuxerListener) {
        synchronized (syncOp) {
            softAudioCore.start(flvDataCollecter, mediaMuxerListener);
