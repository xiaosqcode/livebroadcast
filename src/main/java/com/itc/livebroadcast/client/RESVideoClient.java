...
import com.itc.livebroadcast.core.CameraHelper;
import com.itc.livebroadcast.core.RESHardVideoCore;
import com.itc.livebroadcast.core.RESSoftVideoCore;
import com.itc.livebroadcast.core.RESVideoCore;
...
public class RESVideoClient {
    ...
    public Camera setDisplayOrientation(int displayOrientation) {
        try {
            //设置预览方向，预览方向默认是横屏的，所以这里要调整一下预览方向
    ...
    public boolean startStreaming(RESFlvDataCollecter flvDataCollecter, IMediaMuxerListener mediaMuxerListener) {
        synchronized (syncOp) {
            ...
            videoCore.startStreaming(flvDataCollecter, mediaMuxerListener);
            isStreaming = true;
            return true;
        }
    }
    ...
    public int getCurrentCamera() {
        return videoCore.getCurrentCamera();
    }
}
