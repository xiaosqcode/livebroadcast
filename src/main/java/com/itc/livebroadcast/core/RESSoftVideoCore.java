...
import com.itc.livebroadcast.model.RESVideoBuff;
import com.itc.livebroadcast.render.GLESRender;
import com.itc.livebroadcast.render.IRender;
import com.itc.livebroadcast.render.NativeRender;
import com.itc.livebroadcast.rtmp.RESFlvDataCollecter;
import com.itc.livebroadcast.tools.BuffSizeCalculator;
    ...
    public boolean startStreaming(RESFlvDataCollecter flvDataCollecter, IMediaMuxerListener mediaMuxerListener) {
        synchronized (syncOp) {
            try {
                ...
                videoSenderThread = new VideoSenderThread("VideoSenderThread", dstVideoEncoder, flvDataCollecter, mediaMuxerListener);
