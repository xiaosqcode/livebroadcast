...
import com.itc.livebroadcast.model.RESAudioBuff;
...
public class RESSoftAudioCore {
    ...
    public void start(RESFlvDataCollecter flvDataCollecter, IMediaMuxerListener mediaMuxerListener) {
        synchronized (syncOp) {
            try {
                ...
                audioSenderThread = new AudioSenderThread("AudioSenderThread", dstAudioEncoder, flvDataCollecter, mediaMuxerListener);
