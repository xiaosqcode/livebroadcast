...
import com.itc.livebroadcast.client.CallbackDelivery;
...
import com.itc.livebroadcast.model.MediaCodecGLWapper;
import com.itc.livebroadcast.model.OffScreenGLWapper;
import com.itc.livebroadcast.model.RESConfig;
import com.itc.livebroadcast.model.RESCoreParameters;
import com.itc.livebroadcast.model.ScreenGLWapper;
...
public class RESHardVideoCore implements RESVideoCore {
    ...
    @Override
    public boolean startStreaming(RESFlvDataCollecter flvDataCollecter, IMediaMuxerListener mediaMuxerListener) {
        synchronized (syncOp) {
            videoGLHander.sendMessage(videoGLHander.obtainMessage(VideoGLHandler.WHAT_MUXER_VIDEO, mediaMuxerListener));
    ...
    public boolean destroy() {
        synchronized (syncOp) {
            ...
            videoGLHander.removeCallbacksAndMessages(null);
            videoGLHandlerThread = null;
            videoGLHander = null;
            Log.i("jfioesjotuesipoesw","===="+videoGLHander);
            return true;
        }
    }
    ...
    private class VideoGLHandler extends Handler {
        ...
        //传递IMediaMuxerListener接口对象
        static final int WHAT_MUXER_VIDEO = 0x006;
        ...
        private IMediaMuxerListener mIMediaMuxerListener;
...
//                        encoderMp4(frameBufferTexture);//编码MP4
                ...
                break;
                case WHAT_MUXER_VIDEO: {
                    mIMediaMuxerListener = (IMediaMuxerListener) msg.obj;
                }
                break;
                //开始推流
                case WHAT_START_STREAMING: {
                    ...
                    videoSenderThread = new VideoSenderThread("VideoSenderThread", dstVideoEncoder, (RESFlvDataCollecter) msg.obj, mIMediaMuxerListener);
