 ...
 */
 JNIEXPORT jlong JNICALL Java_com_itc_livebroadcast_rtmp_RtmpClient_open
 ...
 * Signature: ([CI)I
 */
 JNIEXPORT jint JNICALL Java_com_itc_livebroadcast_rtmp_RtmpClient_read
 ...
 * Signature: ([CI)I
 */
 JNIEXPORT jint JNICALL Java_com_itc_livebroadcast_rtmp_RtmpClient_write
 ...
 * Signature: ()I
 */
 JNIEXPORT jint JNICALL Java_com_itc_livebroadcast_rtmp_RtmpClient_close
...
JNIEXPORT jstring JNICALL Java_com_itc_livebroadcast_rtmp_RtmpClient_getIpAddr
